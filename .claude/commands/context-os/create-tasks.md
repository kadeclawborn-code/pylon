...
- `context-os/specs/[this-spec]/spec.md`
- `context-os/specs/[this-spec]/planning/requirements.md`
...
- `context-os/specs/[this-spec]/spec.md` (if present)
- `context-os/specs/[this-spec]/planning/requirements.md` (if present)
- `context-os/specs/[this-spec]/planning/visuals/` and its' contents (if present)
...
✅ Tasks list created: `context-os/specs/[this-spec]/tasks.md`
