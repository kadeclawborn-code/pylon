...
This process will create these files in `context-os/product/` directory.
...
- Create `context-os/product/mission.md` with product vision and strategy
- Create `context-os/product/roadmap.md` with phased development plan
- Create `context-os/product/tech-stack.md` documenting all of this product's tech stack choices
...
✅ Product mission: `context-os/product/mission.md`
✅ Product roadmap: `context-os/product/roadmap.md`
✅ Product tech stack: `context-os/product/tech-stack.md`
