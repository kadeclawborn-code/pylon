...
cat context-os/specs/[current-spec]/planning/requirements.md

# Check for visual assets
ls -la context-os/specs/[current-spec]/planning/visuals/ 2>/dev/null | grep -v "^total" | grep -v "^d"
```
...
Write the main specification to `context-os/specs/[current-spec]/spec.md`.
