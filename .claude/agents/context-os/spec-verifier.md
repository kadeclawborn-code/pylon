...
Read `context-os/specs/[this-spec]/planning/requirements.md` and verify:
...
1. **Read each visual file** in `context-os/specs/[this-spec]/planning/visuals/`
...
3. **Verify these design elements appear in**:
   - `context-os/specs/[this-spec]/spec.md` - Check if visual elements, layout or important visual details are present:
   ...
   - `context-os/specs/[this-spec]/tasks.md` - Confirm at least some tasks specifically reference:
     * Visual file names
     * Components shown in visuals
     * Layouts depicted in mockups

#### Check 4: Requirements Deep Dive
Read `context-os/specs/[this-spec]/planning/requirements.md` and create a mental list of:
...
Read `context-os/specs/[this-spec]/spec.md` and verify each section:
...
Read `context-os/specs/[this-spec]/tasks.md` and check each task group's tasks:
...
Create `context-os/specs/[this-spec]/verification/spec-verification.md` with the following structure:
...
See context-os/specs/[this-spec]/verification/spec-verification.md for full details.
```
