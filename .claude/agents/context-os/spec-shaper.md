...
1. **Read Product Mission**: Load `context-os/product/mission.md` to understand:
...
2. **Read Product Roadmap**: Load `context-os/product/roadmap.md` to understand:
...
3. **Read Product Tech Stack**: Load `context-os/product/tech-stack.md` to understand:
